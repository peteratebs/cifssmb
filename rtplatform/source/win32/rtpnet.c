...
#include <ws2tcpip.h>
#include <windows.h>
#define IPPROTO_IPV6 999 //MSDN 2008 couldn't find tpipv6 so just working around.
#ifndef IPPROTO_IPV6
...
int rtp_net_socket_stream (RTP_HANDLE  *sockHandle)
{
    ...
    if (sock == INVALID_SOCKET)
    {
        *sockHandle = ((RTP_HANDLE)-1);
        ...
        RTP_DEBUG_OUTPUT_NETERRNO("rtp_net_socket_stream:", result);
#endif
        return (-1);
    }
...
#ifdef RTP_DEBUG
        result = WSAGetLastError();
        RTP_DEBUG_OUTPUT_NETERRNO("rtp_net_socket_datagram:", result);
#endif
        return (-1);
    }
...
int rtp_net_bind (RTP_HANDLE sockHandle, unsigned char *ipAddr, int port, int type)
{
    ...
    if (bind ((SOCKET) sockHandle, (const struct sockaddr *) &sin, sizeof (sin)) != 0)
    {
        ...
        {
#ifdef RTP_DEBUG
            RTP_DEBUG_OUTPUT_NETERRNO("rtp_net_bind: non-fatal error returned ", result);
#endif
            return (-2);
        }
        else
        {
#ifdef RTP_DEBUG
            RTP_DEBUG_OUTPUT_NETERRNO("rtp_net_bind:", result);
#endif
            return (-1);
        }
    }
...
#ifdef RTP_DEBUG
        result = WSAGetLastError();
        RTP_DEBUG_OUTPUT_NETERRNO("rtp_net_listen:", result);
#endif
        return (-1);
    }
...
#ifdef RTP_DEBUG
        result = WSAGetLastError();
        RTP_DEBUG_OUTPUT_NETERRNO("rtp_net_getpeername:", result);
#endif
        return (-1);
    }
...
#ifdef RTP_DEBUG
        result = WSAGetLastError();
        RTP_DEBUG_OUTPUT_NETERRNO("rtp_net_getsockname:", result);
#endif
        return (-1);
    }
...
#ifdef RTP_DEBUG
        result = WSAGetLastError();
        RTP_DEBUG_OUTPUT_NETERRNO("rtp_net_getaddrinfo:", result);
#endif
        return (-1);
    }
                    ...
                    unsigned char *ipAddr, int *port, int *type)
{
    ...
    if (conSocket == INVALID_SOCKET)
    {
        *connectSock = ((RTP_HANDLE)-1);
        ...
        {
#ifdef RTP_DEBUG
            RTP_DEBUG_OUTPUT_NETERRNO("rtp_net_accept: non-fatal error returned ", result);
#endif
            return (-2);
        }
#ifdef RTP_DEBUG
        RTP_DEBUG_OUTPUT_NETERRNO("rtp_net_accept:", result);
#endif
        return (-1);
    }
                     ...
                     int port, int type)
{
    ...
    if (connect((SOCKET) sockHandle, (const struct sockaddr *) &sin, sinLen) != 0)
    {
        ...
        {
#ifdef RTP_DEBUG
            RTP_DEBUG_OUTPUT_NETERRNO("rtp_net_connect: non-fatal error returned ", result);
#endif
            return (-2);
        }
#ifdef RTP_DEBUG
        RTP_DEBUG_OUTPUT_NETERRNO("rtp_net_connect:", result);
#endif
        return (-1);
    }
...
unsigned  rtp_net_is_connected    (RTP_SOCKET sockHandle)
{
    ...
    if (getpeername ((SOCKET) sockHandle, (struct sockaddr *) &peerAddr, &peerLen) == 0)
    {
        ...
        if (result != SOCKET_ERROR)
        {
            ...
            result = recv ((SOCKET) sockHandle,(char *) tempBuffer, 1, MSG_PEEK);
            if (result == 1)
            {
                // there is data
                return (1);
...
#ifdef RTP_DEBUG
        result = WSAGetLastError();
        RTP_DEBUG_OUTPUT_NETERRNO("rtp_net_write_select:", result);
#endif
        return (-1);
    }
...
#ifdef RTP_DEBUG
        result = WSAGetLastError();
        RTP_DEBUG_OUTPUT_NETERRNO("rtp_net_read_select:", result);
#endif
        return (-1);
    }
...
long rtp_net_send (RTP_HANDLE sockHandle, const unsigned char * buffer, long size)
{
    ...
    if (result == SOCKET_ERROR)
    {
        ...
        {
#ifdef RTP_DEBUG
            RTP_DEBUG_OUTPUT_NETERRNO("rtp_net_send: non-fatal error returned ", result);
#endif
            return (-2);
        }
#ifdef RTP_DEBUG
        RTP_DEBUG_OUTPUT_NETERRNO("rtp_net_send:", result);
#endif
        return (-1);
    }
    return (result);
...
long rtp_net_recv (RTP_HANDLE sockHandle, unsigned char * buffer, long size)
{
    ...
    if (result == SOCKET_ERROR)
    {
        ...
        {
#ifdef RTP_DEBUG
            RTP_DEBUG_OUTPUT_NETERRNO("rtp_net_recv: non-fatal error returned ", result);
#endif
            return (-2);
        }
#ifdef RTP_DEBUG
        RTP_DEBUG_OUTPUT_NETERRNO("rtp_net_recv:", result);
#endif
        return (-1);
    }
    return (result);
                     ...
                     unsigned char * ipAddr, int port, int type)
{
    ...
    if (result == SOCKET_ERROR)
    {
        ...
        {
#ifdef RTP_DEBUG
            RTP_DEBUG_OUTPUT_NETERRNO("rtp_net_sendto: non-fatal error returned ",result);
#endif
            return (-2);
        }
#ifdef RTP_DEBUG
        RTP_DEBUG_OUTPUT_NETERRNO("rtp_net_sendto:", result);
#endif
        return (-1);
    }
    return (result);
                       ...
                       unsigned char *ipAddr, int *port, int *type)
{
    ...
    if (result == SOCKET_ERROR)
    {
        ...
        {
#ifdef RTP_DEBUG
            RTP_DEBUG_OUTPUT_NETERRNO("rtp_net_recvfrom: non-fatal error returned ", result);
#endif
            return (-2);
        }
#ifdef RTP_DEBUG
        RTP_DEBUG_OUTPUT_NETERRNO("rtp_net_recvfrom:", result);
#endif
        return (-1);
    }
...
#ifdef RTP_DEBUG
        result = WSAGetLastError();
        RTP_DEBUG_OUTPUT_NETERRNO("rtp_net_closesocket:", result);
#endif
        return (-1);
    }
...
#ifdef RTP_DEBUG
        result = WSAGetLastError();
        RTP_DEBUG_OUTPUT_NETERRNO("rtp_net_shutdown:", result);
#endif
        return (-1);
    }
    return (0);
...
#ifdef RTP_DEBUG
        result = WSAGetLastError();
        RTP_DEBUG_OUTPUT_NETERRNO("rtp_net_getntoread:", result);
#endif
        return (-1);
    }
    *nToRead = arg;
...
#ifdef RTP_DEBUG
        result = WSAGetLastError();
        RTP_DEBUG_OUTPUT_NETERRNO("rtp_net_setblocking:", result);
#endif
        return (-1);
    }
    return (0);
...
#ifdef RTP_DEBUG
        result = WSAGetLastError();
        RTP_DEBUG_OUTPUT_NETERRNO("rtp_net_setnagle:", result);
#endif
        return (-1);
    }
    return (0);
...
#ifdef RTP_DEBUG
        result = WSAGetLastError();
        RTP_DEBUG_OUTPUT_NETERRNO("rtp_net_setlinger:", result);
#endif
        return (-1);
    }
    return (0);
...
#ifdef RTP_DEBUG
        result = WSAGetLastError();
        RTP_DEBUG_OUTPUT_NETERRNO("rtp_net_setreuseaddr:", result);
#endif
        return (-1);
    }
    return (0);
...
#ifdef RTP_DEBUG
        result = WSAGetLastError();
        RTP_DEBUG_OUTPUT_NETERRNO("rtp_net_setkeepalive:", result);
#endif
        return (-1);
    }
    return (0);
...
#ifdef RTP_DEBUG
        result = WSAGetLastError();
        RTP_DEBUG_OUTPUT_NETERRNO("rtp_net_setmembership:", result);
#endif
        return (-1);
    }
    return (0);
...
int  rtp_net_setmcastttl(RTP_HANDLE sockHandle, int ttl)
{
    ...
    {
        rtp_printf("Can not figure out the ip version type");
        return (-1);
    }
...
#ifdef RTP_DEBUG
        result = WSAGetLastError();
        RTP_DEBUG_OUTPUT_NETERRNO("rtp_net_setbroadcast:", result);
#endif
        return (-1);
    }
    return (0);
...
#ifdef RTP_DEBUG
        result = WSAGetLastError();
        RTP_DEBUG_OUTPUT_NETERRNO("rtp_net_select:", result);
#endif
        return (-1);
    }
