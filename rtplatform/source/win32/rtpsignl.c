...
int _rtp_sig_semaphore_alloc (RTP_HANDLE *newSem, const char *name)
{
    ...
    {
#ifdef RTP_DEBUG
		RTP_DEBUG_OUTPUT_ERRNO("rtp_sig_semaphore_alloc:");
#endif
        return(-1);
    }
...
void _rtp_sig_semaphore_free (RTP_HANDLE semHandle)
{
    ...
    {
#ifdef RTP_DEBUG
		RTP_DEBUG_OUTPUT_ERRNO("rtp_sig_semaphore_free");
#endif
    }
}
...
int _rtp_sig_semaphore_wait_timed (RTP_HANDLE semHandle, long msecs)
{
    ...
    {
#ifdef RTP_DEBUG
		RTP_DEBUG_OUTPUT_ERRNO("rtp_sig_semaphore_wait_timed:");
#endif
        return (-1);
    }
...
void _rtp_sig_semaphore_clear (RTP_HANDLE semHandle)
{
    ...
    if (result == WAIT_FAILED)
    {
		RTP_DEBUG_OUTPUT_ERRNO("rtp_sig_semaphore_clear:");
    }
#endif
}
...
int _rtp_sig_semaphore_wait (RTP_HANDLE semHandle)
{
    ...
    {
#ifdef RTP_DEBUG
		RTP_DEBUG_OUTPUT_ERRNO("rtp_sig_semaphore_wait:");
#endif
        return (-1);
    }
...
void _rtp_sig_semaphore_signal (RTP_HANDLE semHandle)
{
    ...
    {
#ifdef RTP_DEBUG
		RTP_DEBUG_OUTPUT_ERRNO("rtp_sig_semaphore_signal:");
#endif
    }
}
...
void _rtp_sig_semaphore_signal_isr (RTP_HANDLE semHandle)
{
    ...
    {
#ifdef RTP_DEBUG
		RTP_DEBUG_OUTPUT_ERRNO("rtp_sig_semaphore_signal_isr:");
#endif
    }
}
...
int _rtp_sig_mutex_alloc (RTP_HANDLE *newMutex, const char *name)
{
    ...
    {
#ifdef RTP_DEBUG
		RTP_DEBUG_OUTPUT_ERRNO("rtp_sig_mutex_alloc:");
#endif
        return(-1);
    }
...
void _rtp_sig_mutex_free (RTP_HANDLE mutexHandle)
{
    ...
    {
#ifdef RTP_DEBUG
		RTP_DEBUG_OUTPUT_ERRNO("rtp_sig_mutex_release:");
#endif
    }
}
...
int _rtp_sig_mutex_claim_timed (RTP_HANDLE mutexHandle, long msecs)
{
    ...
    {
#ifdef RTP_DEBUG
		RTP_DEBUG_OUTPUT_ERRNO("rtp_sig_mutex_claim_timed:");
#endif
        return (-1);
    }
...
int _rtp_sig_mutex_claim (RTP_HANDLE mutexHandle)
{
    ...
    {
#ifdef RTP_DEBUG
		RTP_DEBUG_OUTPUT_ERRNO("rtp_sig_mutex_claim:");
#endif
        return (-1);
    }
