...
int result;
    ...
    if (fileHandle == (-1))
    {
        ...
        {
#ifdef RTP_DEBUG
			RTP_DEBUG_OUTPUT_ERRNO("rtp_wfile_open:");
#endif
            return (-2);
        }
#ifdef RTP_DEBUG
...
int rtp_wfile_delete (unsigned short * name)
{
    ...
    {
#ifdef RTP_DEBUG
		RTP_DEBUG_OUTPUT_ERRNO("rtp_wfile_delete:");
#endif
        return (-1);
    }
    return (0);
...
int rtp_wfile_mkdir (unsigned short * name)
{
    ...
    {
#ifdef RTP_DEBUG
		RTP_DEBUG_OUTPUT_ERRNO("rtp_wfile_mkdir:");
#endif
        return (-1);
    }
    return (0);
...
int winmode;
    ...
    {
#ifdef RTP_DEBUG
		RTP_DEBUG_OUTPUT_ERRNO("rtp_wfile_chmode:");
#endif
        return (-1);
    }
    return (0);
